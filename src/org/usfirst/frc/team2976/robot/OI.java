...
//		new JoystickButton(driveStick, Button.B.getBtnNumber()).whileHeld(new ArmTestCode(0.7));
//		new JoystickButton(driveStick, Button.X.getBtnNumber()).whileHeld(new ArmTestCode(-0.7));
